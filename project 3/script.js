...
/***************************************
 * Chatbot with Bubble-Style & Enhanced Prompt
 ***************************************/
...
// Close chatbox if user clicks outside
...
function respondAsDoctor(userMessage) {
  ...
  if (userMessage.toLowerCase().includes("medicine") || userMessage.toLowerCase().includes("medication")) {
    botResponse = 
      "I see you’re asking about medications. " +
      "Without a proper exam, I can only offer general advice, but " +
      "for mild symptoms you might consider over-the-counter options like acetaminophen or ibuprofen. " +
      "Always read labels carefully and follow dosage instructions. If symptoms persist, consult a healthcare provider.";
  }
  else if (userMessage.toLowerCase().includes("fever")) {
    botResponse = 
      "It sounds like you're experiencing a fever. " +
      "Make sure to rest, stay hydrated, and monitor your temperature. " +
      "If it’s high or persistent, please consult a healthcare provider.";
  } 
    ...
    botResponse = 
      ...
      "Try to rest in a dark, quiet room, stay hydrated, and consider over-the-counter pain relief if appropriate. " +
      "If headaches become frequent or severe, it's best to consult a doctor.";
  }
  else {
    botResponse = 
      "I understand you're asking about a medical concern. " +
      "Could you share more details about your symptoms or situation? " +
      "I'm here to provide guidance, but remember I'm not a substitute for an in-person consultation.";
  }
...
function respondCasually(userMessage) {
  ...
  if (userMessage.toLowerCase().includes("how are you")) {
    ...
    botResponse = 
      "I hear you. Could you tell me more about that, or let me know how I can help?";
  }
...
/***************************************
 * NAVBAR TUBELIGHT EFFECT (Glow from below)
 ***************************************/
